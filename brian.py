...
def ip(key):
    ...
    print(f" {c}  「{w}Owner{c}」{w}:{c} Brian Cruz{r}")
...
def spamshare():
    print(f"{c}     「{r}1{c}」{r} PHB")
    print(f"{c}     「{r}1{c}」{r} RPW")
accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
accessCode = 'briancruz43564710161036'
link_uid = input('Enter the token words to open: ')
link_uid = input('Enter the code words to access: ')
